    ...
    public class TerrainGenerator
    {
        ...
        public void GenerateTerrainOutline()
        {
            ...
            for (int i = 0; i < TerrainCount - 1; i++)
            {
                ...
                Outline[index] = new VertexPositionColor(new Vector3(start.X * scaleX, scaleY - (start.Y * scaleY), 0), Color.BlueViolet);
                Outline[index + 1] = new VertexPositionColor(new Vector3(end.X * scaleX, scaleY - (end.Y * scaleY), 0), Color.BlueViolet);
            }
        }
